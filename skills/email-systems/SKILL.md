...
From addresses should come from enprojectnment variables

Message: From email appears hardcoded. Use enprojectnment variable for flexibility.
...
API keys should come from enprojectnment variables

Message: Email API key appears hardcoded in source code. Use enprojectnment variable.
