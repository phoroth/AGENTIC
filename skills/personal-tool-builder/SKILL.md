...
### Tool only works in your specific enprojectnment
...
| Enprojectnment-specific | You can pick a good default |
...
Message: Hardcoded absolute path - use homedir() or enprojectnment variables.
...
Message: Potential hardcoded credential - use enprojectnment variables or config file.
