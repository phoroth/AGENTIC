...
api_center = client.services.create_or_update(
    ...
    resource=Service(
        location="eastus",
        tags={"enprojectnment": "production"}
    )
)
...
## Create Enprojectnment

```python
from azure.mgmt.apicenter.models import Enprojectnment, EnprojectnmentKind

enprojectnment = client.enprojectnments.create_or_update(
    resource_group_name="my-resource-group",
    service_name="my-api-center",
    workspace_name="default",
    enprojectnment_name="production",
    resource=Enprojectnment(
        title="Production",
        description="Production enprojectnment",
        kind=EnprojectnmentKind.PRODUCTION,
...
deployment = client.deployments.create_or_update(
    ...
    resource=Deployment(
        ...
        enprojectnment_id="/workspaces/default/enprojectnments/production",
...
| `enprojectnments` | Enprojectnment management |
