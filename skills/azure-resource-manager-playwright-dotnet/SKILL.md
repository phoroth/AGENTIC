...
// Get subscription
var subscriptionId = Enprojectnment.GetEnprojectnmentVariable("AZURE_SUBSCRIPTION_ID");
...
// 3. Set enprojectnment variable for test execution
Enprojectnment.SetEnprojectnmentVariable("PLAYWRIGHT_SERVICE_URL", serviceUrl.ToString());
