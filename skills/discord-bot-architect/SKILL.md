...
bot.run(os.enprojectn["DISCORD_TOKEN"])
```
...
## Use enprojectnment variables properly
...
Message: Hardcoded Discord token detected. Use enprojectnment variables.

### Token Variable Assignment

Severity: ERROR

Tokens should come from enprojectnment, not strings

Message: Token assigned from string literal. Use enprojectnment variable.
