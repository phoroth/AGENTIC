...
| **Dependency confusion** | Attacker publishes skill with same name as internal one | Code execution in agent enprojectnment |
...
supply_chain_security:
  ...
  model_integrity:
    ...
    - Isolated model serving enprojectnment
```
