...
- **Enprojectnment Separation**: Test credentials must fail in production. Misconfigured gateways commonly accept test cards on live sites.
...
- Enprojectnment variable configuration
