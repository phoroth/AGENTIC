...
edge/serverless enprojectnments.
...
- Pattern: Using pg driver in serverless | Why: TCP connections don't work in all edge enprojectnments | Fix: Use @neondatabase/serverless driver
...
testing, and preview enprojectnments.
...
- https://neon.com/blog/branching-with-preview-enprojectnments
- https://github.com/neondatabase/create-branch-action

### Vercel Preview Enprojectnment Integration
...
# 4. Enprojectnment variables automatically injected
...
// Enprojectnment variables injected by integration
...
Connection strings should use enprojectnment variables

Message: Hardcoded connection string. Use enprojectnment variables.
...
- user needs deployment -> vercel-deployment (Enprojectnment variables, preview databases)
...
- User mentions or implies: preview enprojectnments
