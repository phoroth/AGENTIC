...
- **Enprojectnment-specific deployment**: Apply clickjacking protection only in production or standalone applications, disable or relax during development when embedding in iframes
...
- Applies frame-busting techniques only in production enprojectnments
