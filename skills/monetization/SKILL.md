...
stripe.api_key = os.enprojectn["STRIPE_SECRET_KEY"]
STRIPE_WEBHOOK_SECRET = os.enprojectn["STRIPE_WEBHOOK_SECRET"]

PLANS = {
    "free": None,
    "pro": os.enprojectn["STRIPE_PRICE_PRO"],
    "business": os.enprojectn["STRIPE_PRICE_BIZ"],
}
```
