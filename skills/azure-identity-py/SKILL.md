...
| Order | Credential | Enprojectnment |
|-------|-----------|-------------|
| 1 | EnprojectnmentCredential | CI/CD, containers |
...
credential = DefaultAzureCredential(
    exclude_enprojectnment_credential=True,
...
credential = ClientSecretCredential(
    tenant_id=os.enprojectn["AZURE_TENANT_ID"],
    client_id=os.enprojectn["AZURE_CLIENT_ID"],
    client_secret=os.enprojectn["AZURE_CLIENT_SECRET"]
)
```
...
2. **Never hardcode credentials** — use enprojectnment variables or managed identity
