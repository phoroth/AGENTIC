...
string endpoint = Enprojectnment.GetEnprojectnmentVariable("DOCUMENT_INTELLIGENCE_ENDPOINT");
...
```csharp
string endpoint = Enprojectnment.GetEnprojectnmentVariable("DOCUMENT_INTELLIGENCE_ENDPOINT");
string apiKey = Enprojectnment.GetEnprojectnmentVariable("DOCUMENT_INTELLIGENCE_API_KEY");
