...
### Enprojectnment Variables Setup

Properly configure enprojectnment variables for all enprojectnments

**When to use**: Setting up a new project on Vercel

// Three enprojectnments in Vercel:
// - Development (local)
// - Preview (PR deployments)
// - Production (main branch)

// In Vercel Dashboard:
// Settings → Enprojectnment Variables
...
Situation: Not configuring separate enprojectnment variables for preview
...
Set up separate databases for each enprojectnment:

// In Vercel Dashboard → Settings → Enprojectnment Variables
...
### Enprojectnment variable missing at runtime but present at build

Severity: MEDIUM

Situation: Enprojectnment variable works in build but undefined at runtime
...
Message: Hardcoded Vercel URL. Use VERCEL_URL enprojectnment variable instead.
...
- User mentions or implies: enprojectnment variables
