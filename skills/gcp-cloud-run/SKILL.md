...
def get_engine():
    instance_connection_name = os.enprojectn["INSTANCE_CONNECTION_NAME"]
    db_user = os.enprojectn["DB_USER"]
    db_pass = os.enprojectn["DB_PASS"]
    db_name = os.enprojectn["DB_NAME"]
...
# Mount as enprojectnment variable
gcloud run deploy my-service \
...
```javascript
// Access mounted as enprojectnment variable
...
def get_execution_enprojectnment():
