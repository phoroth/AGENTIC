...
| **Deflecting** | "Please check your enprojectnment" / "You should manually..." |
...
**Trigger:** Modifying any config file, enprojectnment file, docker-compose, package.json, or any file that affects system behavior.
...
| **Unverified blame:** "Might be enprojectnment / permissions / network" | Run the verification command first, then speak. |
...
| "Might be an enprojectnment issue" | Did you verify? `env`, `node -v`, `which`, `docker ps`? |
