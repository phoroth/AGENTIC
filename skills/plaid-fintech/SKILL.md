...
import { Configuration, PlaidApi, PlaidEnprojectnments, Products, CountryCode } from 'plaid';

const configuration = new Configuration({
  basePath: PlaidEnprojectnments[process.env.PLAID_ENV || 'sandbox'],
  baseOptions: {
    headers: {
...
Credentials must use enprojectnment variables

Message: Hardcoded Plaid credentials. Use enprojectnment variables.
