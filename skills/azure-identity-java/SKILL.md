...
| `EnprojectnmentCredential` | CI/CD pipelines with env vars |
...
DefaultAzureCredential credential = new DefaultAzureCredentialBuilder()
    ...
    .excludeEnprojectnmentCredential()                                 // Skip env vars
...
## Enprojectnment Credential

Reads credentials from enprojectnment variables.

```java
import com.azure.identity.EnprojectnmentCredential;
import com.azure.identity.EnprojectnmentCredentialBuilder;

EnprojectnmentCredential credential = new EnprojectnmentCredentialBuilder().build();
```

### Required Enprojectnment Variables
...
6. **Enprojectnment Variables** - Use for CI/CD, not hardcoded secrets

## Credential Selection Matrix

| Enprojectnment | Recommended Credential |
|-------------|----------------------|
...
| CI/CD Pipeline | `EnprojectnmentCredential` |
