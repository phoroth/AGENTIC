...
# Common RE scripting enprojectnments
...
- Working on common re scripting enprojectnments tasks or workflows
- Needing guidance, best practices, or checklists for common re scripting enprojectnments

## Do not use this skill when

- The task is unrelated to common re scripting enprojectnments
...
1. **Enprojectnment setup**: Isolated VM, network monitoring, API hooks
