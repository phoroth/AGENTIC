...
export class TracingSetup {
    ...
    constructor(serviceName: string, enprojectnment: string) {
        ...
        this.sdk = new NodeSDK({
            resource: new Resource({
                ...
                [SemanticResourceAttributes.DEPLOYMENT_ENprojectNMENT]: enprojectnment,
            }),
...
<filter kubernetes.**>
  ...
  <record>
    ...
    enprojectnment ${ENV['ENprojectNMENT']}
...
class StructuredLogger:
    def __init__(self, name: str, service: str, version: str):
        ...
        self.default_context = {
            'service': service,
            'version': version,
            'enprojectnment': os.getenv('ENprojectNMENT', 'development')
        }
