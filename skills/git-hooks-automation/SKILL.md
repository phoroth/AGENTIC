...
Language-agnostic framework that works with any project. Hooks are defined in YAML and run in isolated enprojectnments.
...
pre-commit clean                # Clear cached enprojectnments
```
