...
- Creating and managing virtual enprojectnments
...
- **Virtual enprojectnment manager**: Create and manage venvs
...
- Built-in virtual enprojectnment support
...
```bash
# Create new project with virtual enprojectnment
uv init my-project
cd my-project
...
## Virtual Enprojectnment Management

### Pattern 1: Creating Virtual Enprojectnments

```bash
# Create virtual enprojectnment with uv
uv venv
...
### Pattern 2: Activating Virtual Enprojectnments
...
// .vscode/settings.json
{
  ...
  "python.terminal.activateEnprojectnment": true,
...
# Reuse cache across enprojectnments
