...
setup_enprojectnment() {
    log_info "Setting up benchmark enprojectnment..."
    ...
    if [ ! -d "$SCRIPT_DIR/venv" ]; then
        log_info "Creating virtual enprojectnment..."
    ...
    log_success "Enprojectnment ready"
}
...
SCRIPT_DIR = os.enprojectn.get('SCRIPT_DIR', '.')
RESULTS_DIR = os.enprojectn.get('RESULTS_DIR', './results')
...
SCRIPT_DIR = os.enprojectn.get('SCRIPT_DIR', '.')
RESULTS_DIR = os.enprojectn.get('RESULTS_DIR', './results')
PROBLEM_LIMIT = int(os.enprojectn.get('PROBLEM_LIMIT', '0'))
PROBLEM_TIMEOUT = int(os.enprojectn.get('PROBLEM_TIMEOUT', '120'))
CLAUDE_MODEL = os.enprojectn.get('CLAUDE_MODEL', 'sonnet')
...
PROBLEM_TIMEOUT = int(os.enprojectn.get('PROBLEM_TIMEOUT', '120'))
CLAUDE_MODEL = os.enprojectn.get('CLAUDE_MODEL', 'sonnet')
MAX_RETRIES = int(os.enprojectn.get('MAX_RETRIES', '3'))
...
SCRIPT_DIR = os.enprojectn.get('SCRIPT_DIR', '.')
RESULTS_DIR = os.enprojectn.get('RESULTS_DIR', './results')
PROBLEM_LIMIT = int(os.enprojectn.get('PROBLEM_LIMIT', '10'))  # Default to 10 for SWE-bench
PROBLEM_TIMEOUT = int(os.enprojectn.get('PROBLEM_TIMEOUT', '300'))
CLAUDE_MODEL = os.enprojectn.get('CLAUDE_MODEL', 'sonnet')
