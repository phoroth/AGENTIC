...
- ❌ Don't put secrets (API keys) in `Agent()` arguments — use enprojectnment variables
...
- Set API keys via enprojectnment variables (`OPENAI_API_KEY`, `ANTHROPIC_API_KEY`, etc.) — never hardcode them.
