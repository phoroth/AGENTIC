...
4. Set enprojectnment variables:
   ```bash
...
speech_config = speechsdk.SpeechConfig(
    subscription=os.enprojectn.get('AZURE_SPEECH_KEY'),
    region=os.enprojectn.get('AZURE_SPEECH_REGION')
)
...
aai.settings.api_key = os.enprojectn["ASSEMBLYAI_API_KEY"]
