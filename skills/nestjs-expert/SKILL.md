...
### Configuration & Enprojectnment Management
- Common issues: Enprojectnment variables, configuration validation, async configuration
...
4. Set JWT_SECRET enprojectnment variable
...
1. Set JWT_SECRET in enprojectnment variables
...
- [ ] JWT_SECRET enprojectnment variable is properly configured
