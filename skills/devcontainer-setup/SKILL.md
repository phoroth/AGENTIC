...
description: Creates devcontainers with Claude Code, language-specific tooling (Python/Node/Rust/Go), and persistent volumes. Use when adding devcontainer support to a project, setting up isolated development enprojectnments, or configuring sandboxed Claude Code workspaces.
risk: safe
...
- User wants a sandboxed Claude Code development enprojectnment
- User needs isolated development enprojectnments with persistent configuration
