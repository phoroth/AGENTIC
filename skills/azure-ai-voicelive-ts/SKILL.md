...
Real-time voice AI SDK for building bidirectional voice assistants with Azure AI in Node.js and browser enprojectnments.
...
// Or via enprojectnment variable
// AZURE_LOG_LEVEL=info
```
