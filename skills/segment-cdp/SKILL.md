...
Direct HTTP API for any enprojectnment. Useful for edge functions,
...
Write key should use enprojectnment variables

Message: Hardcoded Segment write key. Use enprojectnment variables.
