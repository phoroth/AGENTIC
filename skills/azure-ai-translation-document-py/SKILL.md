...
endpoint = os.enprojectn["AZURE_DOCUMENT_TRANSLATION_ENDPOINT"]
key = os.enprojectn["AZURE_DOCUMENT_TRANSLATION_KEY"]
...
source_url = os.enprojectn["AZURE_SOURCE_CONTAINER_URL"]
target_url = os.enprojectn["AZURE_TARGET_CONTAINER_URL"]
