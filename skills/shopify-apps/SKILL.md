...
Message: Hardcoded Shopify API secret. Use enprojectnment variables.

### Hardcoded Shopify API Key

Severity: ERROR

API keys should use enprojectnment variables

Message: Hardcoded Shopify API key. Use enprojectnment variables.
