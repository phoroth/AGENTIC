...
- Set `HF_TOKEN` enprojectnment variable with Write-access token
- For Artificial Analysis: Set `AA_API_KEY` enprojectnment variable
...
- **Solution**: Set enprojectnment variable or add to .env file
