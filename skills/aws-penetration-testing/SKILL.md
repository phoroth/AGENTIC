...
description: "Provide comprehensive techniques for penetration testing AWS cloud enprojectnments. Covers IAM enumeration, privilege escalation, SSRF to metadata endpoint, S3 bucket exploitation, Lambda code extraction, and persistence techniques for red team operations."
risk: offensive
source: community
author: zebbern
...
> AUTHORIZED USE ONLY: Use this skill only for authorized security assessments, defensive validation, or controlled educational enprojectnments.

# AWS Penetration Testing

## Purpose

Provide comprehensive techniques for penetration testing AWS cloud enprojectnments. Covers IAM enumeration, privilege escalation, SSRF to metadata endpoint, S3 bucket exploitation, Lambda code extraction, and persistence techniques for red team operations.
...
```bash
# Read enprojectnment for credential path
/proc/self/enprojectn
