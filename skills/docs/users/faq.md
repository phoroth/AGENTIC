...
`Sync Skills` is only meant for local maintainer/development runs behind the Vite dev server, and it stays hidden unless the local enprojectnment explicitly enables it.
