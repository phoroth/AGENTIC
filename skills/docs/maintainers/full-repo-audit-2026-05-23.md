...
### Medium - app enprojectnment docs name an unused canonical URL variable
...
- Risk: maintainers testing non-default hosts may set an enprojectnment variable that has no effect on sitemap/prerender canonical URLs.
