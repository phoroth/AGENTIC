...
- If the skill can alter files/systems or run dangerous actions, document confirmation gates and enprojectnment expectations (`local-only`, `authorized test enprojectnment`, etc.).
