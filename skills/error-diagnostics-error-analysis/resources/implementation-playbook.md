...
- **Configuration Errors**: Missing enprojectnment variables, invalid settings, version mismatches
...
- **Enprojectnmental**: Only happens in specific enprojectnments or configurations
...
- `enprojectnment`: dev, staging, production
...
For errors in production enprojectnments where debuggers aren't available:
...
Sentry.init({
  ...
  enprojectnment: process.env.NODE_ENV,
...
func initTracer() (*sdktrace.TracerProvider, error) {
    ...
    tp := sdktrace.NewTracerProvider(
        ...
        sdktrace.WithResource(resource.NewWithAttributes(
            ...
            attribute.String("enprojectnment", "production"),
        )),
    )
