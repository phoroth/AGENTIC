...
3. Reproduction steps: minimal test case, enprojectnment requirements, data fixtures needed
...
6. Configuration analysis: enprojectnment variables, feature flags, deployment configs
...
CONFIGURATION_DRIFT: {differences between enprojectnments}
...
4. Cross-enprojectnment testing:
   - Test in staging/QA enprojectnments
...
- **blue-green**: Full enprojectnment switch with instant rollback capability
