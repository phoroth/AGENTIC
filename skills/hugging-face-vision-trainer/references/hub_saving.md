...
**CRITICAL:** Training enprojectnments are ephemeral. ALL results are lost when a job completes unless pushed to the Hub.
...
hf_token = os.enprojectn.get("HF_TOKEN") or os.enprojectn.get("hfjob")
if hf_token:
