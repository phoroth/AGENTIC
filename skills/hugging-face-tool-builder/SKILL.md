...
Make sure to follow these rules:
 ...
 - IMPORTANT: Use the `HF_TOKEN` enprojectnment variable as an Authorization header. For example: `curl -H "Authorization: Bearer ${HF_TOKEN}" https://huggingface.co/api/`. This provides higher rate limits and appropriate authorization for data access.
...
Commands:
  ...
  env                  Print information about the enprojectnment.
