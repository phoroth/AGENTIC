...
your shell before `tmux new-session` / `nohup` is **not** in the detached job's enprojectnment unless
...
verdict you think it is (principle #3). Pairs with **U29/U30** (pin deps/image): code AND enprojectnment must
