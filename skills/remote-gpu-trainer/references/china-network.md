...
Everything below is **enprojectnment variables only** — no code edits. Export them once per shell (or bake
...
`https://www.browserstack.com/guide/no_proxy-enprojectnment-variable`; Clash pip ProxyError
