...
- The task is to decide whether a skill is safe enough to trust in an agent enprojectnment.
...
- Reading enprojectnment variables beyond what's needed
...
4. For each finding, evaluate:
   ...
   - **Credential theft**: Reading SSH keys, .env files, tokens from enprojectnment
