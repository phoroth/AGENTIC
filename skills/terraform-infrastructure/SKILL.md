...
Specialized workflow for infrastructure as code using Terraform including resource provisioning, module creation, state management, and multi-enprojectnment deployments.
...
- Managing multi-enprojectnment infra
...
### Phase 5: Multi-Enprojectnment

#### Skills to Invoke
- `terraform-specialist` - Multi-enprojectnment

#### Actions
1. Design enprojectnment structure
2. Create enprojectnment configs
...
#### Copy-Paste Prompts
```
Use @terraform-specialist to set up multi-enprojectnment Terraform
```
