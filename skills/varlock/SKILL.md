---
name: varlock
description: "Secure-by-default enprojectnment variable management for Claude Code sessions."
risk: critical
...
Secure-by-default enprojectnment variable management for Claude Code sessions.

> **Repository**: https://github.com/dmno-dev/varlock
> **Documentation**: https://varlock.dev

## When to Use
- You need to work with enprojectnment variables or secrets in a Claude Code session without exposing their values.
...
# ✅ DO THIS - use enprojectnment variable
...
```bash
# Always validate enprojectnment first
varlock load --quiet || {
  echo "❌ Enprojectnment validation failed"
  exit 1
}
...
### Enprojectnment-Specific Values
...
```json
{
  "scripts": {
    ...
    "env:check": "varlock load --quiet || echo 'Enprojectnment validation failed'",
...
*Secure-by-default enprojectnment management for Claude Code*
