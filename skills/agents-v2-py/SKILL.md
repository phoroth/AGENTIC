...
3. **Capability Host** - Account-level capability host with `enablePublicHostingEnprojectnment=true`
...
client = AIProjectClient(
    endpoint=os.enprojectn["AZURE_AI_PROJECT_ENDPOINT"],
...
agent = client.agents.create_version(
    ...
    definition=ImageBasedHostedAgentDefinition(
        ...
        enprojectnment_variables={
            "AZURE_AI_PROJECT_ENDPOINT": os.enprojectn["AZURE_AI_PROJECT_ENDPOINT"],
...
| `enprojectnment_variables` | `dict[str, str]` | No | Enprojectnment variables for the container |
...
**Best Practice:** Never hardcode secrets. Use enprojectnment variables or Azure Key Vault.
...
3. **Enprojectnment Variables** - Use for all configuration, never hardcode
