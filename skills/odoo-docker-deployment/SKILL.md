...
description: "Production-ready Docker and docker-compose setup for Odoo with PostgreSQL, persistent volumes, enprojectnment-based configuration, and Nginx reverse proxy."
risk: safe
source: "self"
---
...
This skill provides a complete, production-ready Docker setup for Odoo, including PostgreSQL, persistent file storage, enprojectnment variable configuration, and an optional Nginx reverse proxy with SSL. It covers both development and production configurations.

## When to Use This Skill

- Spinning up a local Odoo development enprojectnment with Docker.
...
- ❌ **Don't:** Mount `odoo.conf` and rely on it for secrets in CI/CD — use Docker secrets or enprojectnment variables instead.
