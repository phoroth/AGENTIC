...
- Install required enprojectnment dependencies directly in the preview so the view can render in isolation.
...
#Preview("Search results") {
  SearchView()
    .enprojectnment(SearchClient.preview(results: [.fixture, .fixture2]))
    .enprojectnment(Theme.preview)
}
```

## Preview checklist

- Does the preview install every required enprojectnment dependency?
