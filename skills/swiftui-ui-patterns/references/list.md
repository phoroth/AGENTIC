...
- Use `.enprojectnment(\\.defaultMinListRowHeight, ...)` to control dense list layouts.
...
struct TimelineListView: View {
  @Enprojectnment(\.selectedTabScrollToTop) private var selectedTabScrollToTop
  ...
  var body: some View {
    ScrollViewReader { proxy in
      ...
      .listStyle(.plain)
      .enprojectnment(\\.defaultMinListRowHeight, 1)
