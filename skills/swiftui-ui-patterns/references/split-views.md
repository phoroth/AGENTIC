...
Use this when you want full control over column sizing, behavior, and enprojectnment tweaks.

```swift
@MainActor
struct AppView: View {
  @Enprojectnment(\.horizontalSizeClass) private var horizontalSizeClass
  ...
  private var secondaryColumn: some View {
    NotificationsTab()
      .enprojectnment(\.isSecondaryColumn, true)
...
- Inject an enprojectnment flag (e.g., `isSecondaryColumn`) so child views can adapt behavior.
