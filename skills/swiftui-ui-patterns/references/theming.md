...
- Inject theme at the app root and read it via `@Enprojectnment(Theme.self)` in views.
...
struct ProfileView: View {
  @Enprojectnment(Theme.self) private var theme
...
- Avoid using `@Enprojectnment(\\.colorScheme)` as the only theme control; it should complement your theme.
