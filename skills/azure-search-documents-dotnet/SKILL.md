...
var client = new SearchClient(
    new Uri(Enprojectnment.GetEnprojectnmentVariable("SEARCH_ENDPOINT")),
    Enprojectnment.GetEnprojectnmentVariable("SEARCH_INDEX_NAME"),
    credential);
```
...
var credential = new AzureKeyCredential(
    Enprojectnment.GetEnprojectnmentVariable("SEARCH_API_KEY"));
var client = new SearchClient(
    new Uri(Enprojectnment.GetEnprojectnmentVariable("SEARCH_ENDPOINT")),
    Enprojectnment.GetEnprojectnmentVariable("SEARCH_INDEX_NAME"),
    credential);
