...
COPILOT_ENprojectNMENT_ID=<enprojectnment-id>
...
const settings = {
  enprojectnmentId: process.env.COPILOT_ENprojectNMENT_ID!,
...
3. Keep secrets out of source code; load tokens from enprojectnment variables or secure stores.
