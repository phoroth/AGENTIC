...
- Questioning a **convention** requires checking if the enprojectnment has changed
...
- Has the underlying enprojectnment (technology, demographics, market, regulation) changed significantly since then? / 底层环境变了吗？
