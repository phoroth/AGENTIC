---
name: spatial-design
description: Web and App implementation guide for Spatial Design. Trigger when user wants enprojectnment-aware layouts, Apple Vision Pro inspiration, and mixed reality aesthetics.
...
## Core Principles
1. **Enprojectnmental Transparency**: The UI acts like a glass pane. It is deeply reliant on background blur, but specifically aims to let the enprojectnment (or a simulated enprojectnment image) dictate the mood.
...
## Visual DNA
- **Colors**: Almost exclusively uses `rgba()` white or black. The actual color comes entirely from the background enprojectnment.
...
body {
  ...
  background: url('room-enprojectnment.jpg') cover;
}
...
struct SpatialDesignView: View {
    var body: some View {
        ZStack {
            // Enprojectnment background
            Image("room-enprojectnment")
                .resizable()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        fit: StackFit.expand,
        children: [
          Image.asset('assets/room-enprojectnment.jpg', fit: BoxFit.cover),
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Enprojectnmental UI', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
...
fun SpatialDesignScreen() {
    Box(modifier = Modifier.fillMaxSize()) {
        Image(painterResource(R.drawable.room_enprojectnment), null, contentScale = ContentScale.Crop, modifier = Modifier.fillMaxSize())
        ...
        Box(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                Text("Enprojectnmental UI", color = Color.White, fontSize = 28.sp, fontWeight = FontWeight.Bold)
