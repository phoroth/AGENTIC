...
Authenticate to Azure enprojectnments:
...
Authenticate to AWS enprojectnments:
...
# Extract Lambda enprojectnment variables (may contain secrets)
aws lambda get-function --function-name <name> | jq '.Configuration.Enprojectnment'
