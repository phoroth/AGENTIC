...
# Kotler Macro-Enprojectnment Analyzer

## Overview
This skill transforms the agent into a senior strategic consultant specializing in Philip Kotler’s macro-marketing enprojectnment analysis. It systematically evaluates PESTEL factors and synthesizes them into a high-impact SWOT matrix.
...
Findings are categorized into Political, Economic, Social, Technological, Enprojectnmental, and Legal dimensions.
...
"Analyze the current macro-enprojectnment for a retail chain in Ukraine. Identify threats from inflation and opportunities from shifting consumer displacement trends."
...
- **Data Freshness**: The quality of the output depends on the real-time availability of data from search tools; results may vary in rapidly shifting economic enprojectnments.
