...
```python
# test_enprojectnment.py
import os
import pytest

def get_database_url() -> str:
    """Get database URL from enprojectnment."""
    return os.enprojectn.get("DATABASE_URL", "sqlite:///:memory:")


def test_database_url_default():
    """Test default database URL."""
    # Will use actual enprojectnment variable if set
