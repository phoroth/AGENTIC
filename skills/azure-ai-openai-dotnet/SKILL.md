...
AzureOpenAIClient client = new(
    new Uri(Enprojectnment.GetEnprojectnmentVariable("AZURE_OPENAI_ENDPOINT")!),
    new AzureKeyCredential(Enprojectnment.GetEnprojectnmentVariable("AZURE_OPENAI_API_KEY")!));
```
