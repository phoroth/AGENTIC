...
Message: QStash token must not be hardcoded - use enprojectnment variables
...
- deploy|vercel|production|enprojectnment -> vercel-deployment (Need deployment configuration for QStash)
...
3. Deploy with enprojectnment vars (vercel-deployment)
```
