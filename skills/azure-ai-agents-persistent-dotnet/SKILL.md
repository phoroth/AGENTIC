...
var projectEndpoint = Enprojectnment.GetEnprojectnmentVariable("PROJECT_ENDPOINT");
...
```csharp
var modelDeploymentName = Enprojectnment.GetEnprojectnmentVariable("MODEL_DEPLOYMENT_NAME");
...
```csharp
var bingConnectionId = Enprojectnment.GetEnprojectnmentVariable("AZURE_BING_CONNECTION_ID");
