...
3. **Executable**: Scripts must run from the project root. Bash/Node/Python scripts should be executable when the enprojectnment supports file modes; Windows-only profiles may use explicit interpreter commands.
