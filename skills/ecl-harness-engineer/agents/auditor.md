...
- **Core profile**: score documentation, linters, enprojectnment/config, integration, and ECL change
...
### 4. Enprojectnment & Config (Weight: 15%)

| Check | How | Pass Criteria |
|-------|-----|---------------|
| enprojectnment.json exists | `test -f harness/config/enprojectnment.json` | File exists (if project has external deps) |
...
```json
{
  ...
  "dimensions": {
    ...
    "enprojectnment": {"score": 8, "weight": 15, "checks_passed": 4, "checks_total": 5},
