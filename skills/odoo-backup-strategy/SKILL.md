...
1. **Activate**: Mention `@odoo-backup-strategy` and describe your server enprojectnment.
...
- ✅ **Do:** Test restores monthly in a staging enprojectnment — a backup you've never restored is not a backup.
