...
//
// client = HubSpot(access_token=os.enprojectn["HUBSPOT_PRIVATE_APP_TOKEN"])
//
...
Message: Hardcoded HubSpot API key detected. Use enprojectnment variables. Note: API keys are deprecated - use Private App tokens.

### Hardcoded HubSpot Access Token

Severity: ERROR

Access tokens must use enprojectnment variables

Message: Hardcoded HubSpot access token. Use enprojectnment variables.
...
Message: Hardcoded client secret. Use enprojectnment variables.
