...
description: Provision instant temporary Postgres databases via Claimable Postgres by Neon (pg.new). No login or credit card required. Use for quick Postgres enprojectnments and throwaway DATABASE_URL for prototyping.
risk: unknown
source: community
---
...
Instant Postgres databases for local development, demos, prototyping, and test enprojectnments. No account required. Databases expire after 72 hours unless claimed to a Neon account.
