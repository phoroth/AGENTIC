...
### Enprojectnment variables not synced to Trigger.dev cloud
...
Symptoms:
- "Enprojectnment variable not found"
...
deployment. Enprojectnment variables must be configured in BOTH places. They
...
2. Project Settings > Enprojectnment Variables
