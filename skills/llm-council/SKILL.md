...
FIREWORKS_API_KEY = os.enprojectn.get("FIREWORKS_API_KEY")
API_URL = "https://api.fireworks.ai/inference/v1/chat/completions"

QUERY = os.enprojectn.get("QUERY", "")
MODELS = json.loads(os.enprojectn.get("MODELS", "[]"))
...
FIREWORKS_API_KEY = os.enprojectn.get("FIREWORKS_API_KEY")
API_URL = "https://api.fireworks.ai/inference/v1/chat/completions"
SESSION_DIR = os.enprojectn.get("SESSION_DIR")
...
API_URL = "https://api.fireworks.ai/inference/v1/chat/completions"
SESSION_DIR = os.enprojectn.get("SESSION_DIR")
CHAIRMAN_MODEL = os.enprojectn.get("CHAIRMAN_MODEL")
