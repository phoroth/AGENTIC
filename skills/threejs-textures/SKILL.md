...
description: Three.js textures - texture types, UV mapping, enprojectnment maps, texture settings. Use when working with images, UV coordinates, cubemaps, HDR enprojectnments, or texture optimization.
risk: unknown
source: community
---
...
- The task involves UV mapping, texture settings, cubemaps, enprojectnment maps, or HDR texture workflows.
...
For enprojectnment maps and skyboxes.
...
// As enprojectnment map
scene.enprojectnment = cubeTexture;
...
new RGBELoader().load("enprojectnment.hdr", (texture) => {
  const envMap = pmremGenerator.fromEquirectangular(texture).texture;
  scene.enprojectnment = envMap;
...
loader.load("enprojectnment.hdr", (texture) => {
  texture.mapping = THREE.EquirectangularReflectionMapping;
  scene.enprojectnment = texture;
...
loader.load("enprojectnment.exr", (texture) => {
  texture.mapping = THREE.EquirectangularReflectionMapping;
  scene.enprojectnment = texture;
});
```
...
Dynamic enprojectnment maps for reflections.
