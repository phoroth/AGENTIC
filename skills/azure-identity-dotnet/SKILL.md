...
|-------|------------|-------------------|
| 1 | EnprojectnmentCredential | Yes |
...
var credential = new DefaultAzureCredential(
    ...
    {
        ExcludeEnprojectnmentCredential = true,
...
## Enprojectnment-Based Configuration

```csharp
// Production vs Development
TokenCredential credential = builder.Enprojectnment.IsProduction()
...
| | `EnprojectnmentCredential` | Enprojectnment variables |
...
| `CredentialUnavailableException` | Credential cannot authenticate in current enprojectnment |
