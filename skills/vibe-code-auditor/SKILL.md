...
**Assumptions:** [list any assumptions made about context or enprojectnment]
...
2. **Context** _(optional)_: Brief description of what the system does, its intended scale, deployment enprojectnment, and known constraints.
3. **Target enprojectnment** _(optional)_: Target runtime (e.g., production web service, CLI tool, data pipeline). Used to calibrate risk severity.
