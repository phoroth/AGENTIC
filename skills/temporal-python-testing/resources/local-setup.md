...
Comprehensive guide for setting up local Temporal development enprojectnment with pytest integration and coverage tracking.
...
async def workflow_env():
    """Module-scoped time-skipping enprojectnment"""
...
@pytest.fixture
def activity_env():
    """Function-scoped activity enprojectnment"""
...
1. **Isolated Enprojectnment**: Use Docker Compose for reproducible local setup
