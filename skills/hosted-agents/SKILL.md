---
name: hosted-agents
description: Build background agents in sandboxed enprojectnments. Use for hosted coding agents, sandboxed VMs, Modal sandboxes, and remote coding enprojectnments.
risk: unknown
source: community
---
...
Hosted agents run in remote sandboxed enprojectnments rather than on local machines. When designed well, they provide unlimited concurrency, consistent execution enprojectnments, and multiplayer collaboration. The critical insight is that session speed should be limited only by model provider time-to-first-token, with all infrastructure setup completed before the user starts their session.

## When to Use
Activate this skill when:
- Building background coding agents that run independently of user devices
- Designing sandboxed execution enprojectnments for agent workloads
...
Hosted agents address the fundamental limitation of local agent execution: resource contention, enprojectnment inconsistency, and single-user constraints. By moving agent execution to remote sandboxed enprojectnments, teams gain unlimited concurrency, reproducible enprojectnments, and collaborative workflows.
...
**The Core Challenge**
Spinning up full development enprojectnments quickly is the primary technical challenge. Users expect near-instant session starts, but development enprojectnments require cloning repositories, installing dependencies, and running build steps.

**Image Registry Pattern**
Pre-build enprojectnment images on a regular cadence (every 30 minutes works well). Each image contains:
...
1. Pre-build enprojectnment images on regular cadence (30 minutes is a good default)
...
- tool-design - Designing tools for hosted enprojectnments
