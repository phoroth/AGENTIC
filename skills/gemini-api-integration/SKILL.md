...
genai.configure(api_key=os.enprojectn["GEMINI_API_KEY"])
...
- ✅ **Do:** Store API keys in enprojectnment variables, never hard-code them
...
**Solution:** Ensure `GEMINI_API_KEY` enprojectnment variable is set and the key is active in Google AI Studio.
