            ...
            return [
                ...
                },
                {
                    ...
                    'tasks': [
                        ...
                        'Configure development enprojectnment',
...
class RollbackManager:
    ...
    def _blue_green_rollback(self):
        return [
            "1. Verify green enprojectnment is problematic",
            "2. Update load balancer to route 100% to blue",
            "3. Monitor blue enprojectnment stability",
            "4. Notify stakeholders of rollback",
            "5. Begin root cause analysis",
            "6. Keep green enprojectnment for debugging"
        ]
```
