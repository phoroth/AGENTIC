...
### Sandboxed Enprojectnment Pattern

Computer use agents MUST run in isolated, sandboxed enprojectnments.
...
# Dockerfile for sandboxed computer use enprojectnment
# Based on Anthropic's reference implementation pattern

FROM ubuntu:22.04

# Install desktop enprojectnment
...
class SandboxedAgent:
    ...
    def start(self):
        """Start sandboxed enprojectnment."""
        # Build network rules
        network_rules = ""
...
**When to use**: Production computer use deployments,Debugging automation failures,Security-sensitive enprojectnments
...
## Test in isolated enprojectnment first
...
Computer use agents MUST run in sandboxed enprojectnments
