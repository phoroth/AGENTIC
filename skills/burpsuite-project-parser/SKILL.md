...
The script uses enprojectnment variables for platform compatibility:
...
The wrapper script requires two enprojectnment variables to locate Burp Suite's bundled Java and JAR file.
