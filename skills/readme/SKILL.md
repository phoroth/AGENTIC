...
- .env.example, .env.sample, or documented enprojectnment variables
- Rails config files (config/database.yml, config/application.rb, config/enprojectnments/)
...
### 4. Enprojectnment Setup

Copy the example enprojectnment file:
...
# Or for enprojectnment-specific credentials
...
# Run with enprojectnment variables
...
5. Add enprojectnment variables in dashboard
...
6. **Use Tables for Reference** - Enprojectnment variables, scripts, and options work great as tables.
