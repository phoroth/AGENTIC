...
**All commands must use the `run.py` wrapper to ensure proper enprojectnment:**
...
### run.py
Script wrapper that handles enprojectnment setup.
...
1. **Always use run.py** - Ensures enprojectnment
