...
The virtual enprojectnment is automatically managed:
...
1. **Always use run.py** - Handles enprojectnment automatically
...
- `.venv/` - Isolated Python enprojectnment (auto-created on first run)
