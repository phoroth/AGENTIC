...
- Creates an isolated Python enprojectnment (`.venv`)
...
├── .venv/                # Isolated Python enprojectnment (auto-created)
...
### **Self-Contained**
Everything runs in the skill folder with an isolated Python enprojectnment. No global installations.
...
- **python-dotenv==1.2.2**: Enprojectnment configuration
...
- Test in safe enprojectnments first
