...
- **HF_TOKEN for Hub Push** ⚠️ CRITICAL - Training enprojectnment is ephemeral, must push to Hub or ALL training results are lost
...
**⚠️ EPHEMERAL ENprojectNMENT—MUST PUSH TO HUB**

The Jobs enprojectnment is temporary. All files are deleted when the job ends. If the model isn't pushed to Hub, **ALL TRAINING IS LOST**.
...
4. **Always enable Hub push** - Enprojectnment is ephemeral; without push, all results lost
