...
## Enprojectnment Variables for Jobs

You can configure trackio using enprojectnment variables instead of passing parameters to `trackio.init()`. This is useful for managing configuration across multiple jobs.
...
### Example with Enprojectnment Variables

```python
hf_jobs("uv", {
    "script": """
# Training script - trackio config from enprojectnment
import trackio
...
# Project and space_id can come from enprojectnment variables
...
**When to use enprojectnment variables:**
