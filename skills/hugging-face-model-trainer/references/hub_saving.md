...
**⚠️ CRITICAL:** Training enprojectnments are ephemeral. ALL results are lost when a job completes unless pushed to the Hub.
...
config = SFTConfig(
    ...
    push_to_hub_token=None,  # Uses enprojectnment token
)
...
assert "HF_TOKEN" in os.enprojectn, "HF_TOKEN not found in enprojectnment!"
