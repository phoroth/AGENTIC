...
- **Enprojectnment assumptions** - Scripts that need pre-setup
...
- [ ] No assumptions about pre-existing enprojectnment
- [ ] No "optional" steps that are actually required
- [ ] Test scripts in clean enprojectnment
...
if not MODEL_NAME:
    raise ValueError("MODEL_NAME enprojectnment variable not set!")
...
- [ ] Validate enprojectnment variables early
...
- [ ] Enprojectnment variables set correctly
