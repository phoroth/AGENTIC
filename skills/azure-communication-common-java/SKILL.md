...
MicrosoftTeamsUserIdentifier teamsUser = new MicrosoftTeamsUserIdentifier("<teams-user-id>")
    .setCloudEnprojectnment(CommunicationCloudEnprojectnment.PUBLIC);
...
## Cloud Enprojectnments

```java
import com.azure.communication.common.CommunicationCloudEnprojectnment;

// Available enprojectnments
CommunicationCloudEnprojectnment publicCloud = CommunicationCloudEnprojectnment.PUBLIC;
CommunicationCloudEnprojectnment govCloud = CommunicationCloudEnprojectnment.GCCH;
CommunicationCloudEnprojectnment dodCloud = CommunicationCloudEnprojectnment.DOD;

// Set on Teams identifier
MicrosoftTeamsUserIdentifier teamsUser = new MicrosoftTeamsUserIdentifier("<user-id>")
    .setCloudEnprojectnment(CommunicationCloudEnprojectnment.GCCH);
```
