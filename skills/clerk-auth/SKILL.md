...
Includes ClerkProvider, enprojectnment variables, and basic
...
# Enprojectnment variables (.env.local)
...
Clerk keys should use enprojectnment variables

Message: Hardcoded Clerk keys. Use enprojectnment variables.
