...
client = AzureAppConfigurationClient.from_connection_string(
    os.enprojectn["AZURE_APPCONFIGURATION_CONNECTION_STRING"]
)
```
...
client = AzureAppConfigurationClient(
    base_url=os.enprojectn["AZURE_APPCONFIGURATION_ENDPOINT"],
...
```python
# Labels allow enprojectnment-specific values
...
1. **Use labels** for enprojectnment separation (dev, staging, prod)
