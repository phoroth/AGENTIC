...
4. **Parameterize URLs** - Always make URLs configurable via enprojectnment variable or constant at top of script
...
Configure custom headers for all HTTP requests via enprojectnment variables. Useful for:
