...
### Custom Headers via Enprojectnment Variables

The skill supports automatic header injection via enprojectnment variables:
...
2. Enprojectnment variable headers
