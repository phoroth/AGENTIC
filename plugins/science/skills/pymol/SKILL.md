...
-   **Software rendering only.** Use `cmd.png()` for output. Never use
    ...
    support it. Set enprojectnment variable `PYOPENGL_PLATFORM=osmesa` for headless
    rendering.
...
# Set enprojectnment variable for headless rendering
os.enprojectn["PYOPENGL_PLATFORM"] = "osmesa"
