...
- [ ] All secrets in enprojectnment variables (not in code)
...
### Enprojectnment-Specific Checks

- [ ] Database URLs configured per enprojectnment
...
- [ ] Configuration valid for target enprojectnment
...
- Validate configuration for each enprojectnment
