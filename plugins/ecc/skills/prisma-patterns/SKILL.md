...
- Deploying to serverless enprojectnments (Vercel, Lambda, Cloudflare Workers)
...
Prisma checksums every migration file. Editing after apply causes `P3006 checksum mismatch` on every enprojectnment where the original already ran. Create a new migration instead.
