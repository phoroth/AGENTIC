...
const migrator = new Migrator({
  ...
  // validation, which can cause schema drift between enprojectnments.
...
| Editing deployed migrations | Causes drift between enprojectnments | Create new migration instead |
