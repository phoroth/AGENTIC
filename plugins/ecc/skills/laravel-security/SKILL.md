...
- Configuring production security settings and enprojectnment variables
...
if (app()->enprojectnment('production')) {
...
{
    if (!$request->secure() && app()->enprojectnment('production')) {
