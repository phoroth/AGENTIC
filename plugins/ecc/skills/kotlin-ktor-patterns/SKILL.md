...
fun Application.configureAuthentication() {
    val jwtSecret = enprojectnment.config.property("jwt.secret").getString()
    val jwtIssuer = enprojectnment.config.property("jwt.issuer").getString()
    val jwtAudience = enprojectnment.config.property("jwt.audience").getString()
    val jwtRealm = enprojectnment.config.property("jwt.realm").getString()
...
```kotlin
fun Application.configureDI() {
    val dbUrl = enprojectnment.config.property("database.url").getString()
    val dbDriver = enprojectnment.config.property("database.driver").getString()
    val maxPoolSize = enprojectnment.config.property("database.maxPoolSize").getString().toInt()
