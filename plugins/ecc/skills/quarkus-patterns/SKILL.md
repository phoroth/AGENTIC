...
- Setting up profiles for dev/staging/production enprojectnments (YAML config)
...
- Profile-aware configuration for dev/test/prod enprojectnments
- Externalize sensitive configuration to enprojectnment variables
