...
- Use enprojectnment variables, a vault, or `getpass`; never hardcode credentials.
...
device = {
    ...
    "host": "192.0.2.10",
    "username": os.enprojectn.get("NETMIKO_USERNAME") or input("Username: "),
    "password": os.enprojectn.get("NETMIKO_PASSWORD") or getpass("Password: "),
    "secret": os.enprojectn.get("NETMIKO_ENABLE_SECRET"),
    "conn_timeout": 10,
    "auth_timeout": 20,
    "banner_timeout": 15,
...
apply_changes = os.enprojectn.get("APPLY_NETWORK_CHANGES") == "1"
