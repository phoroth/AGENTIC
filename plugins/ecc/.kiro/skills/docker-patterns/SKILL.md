...
description: >
  ...
  setting up containerized development enprojectnments or reviewing Docker configurations.
metadata:
  origin: ECC
---
...
```yaml
# GOOD: Use enprojectnment variables (injected at runtime)
services:
  app:
    env_file:
      - .env                     # Never commit .env to git
    enprojectnment:
      - API_KEY                  # Inherits from host enprojectnment
