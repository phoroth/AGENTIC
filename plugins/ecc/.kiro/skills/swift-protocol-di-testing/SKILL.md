...
- Building modules that work across enprojectnments (app, test, SwiftUI preview)
...
- Testing error handling paths that are hard to trigger in real enprojectnments
