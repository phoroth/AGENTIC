...
fun Application.module() {
    val config = DatabaseConfig(
        url = enprojectnment.config.property("database.url").getString(),
        username = enprojectnment.config.property("database.username").getString(),
        password = enprojectnment.config.property("database.password").getString(),
    )
