...
Set the following enprojectnment variables to use Atlas Cloud as your LLM backend:
...
client = OpenAI(
    api_key=os.enprojectn["ATLAS_API_KEY"],
    base_url=os.enprojectn.get("ATLAS_BASE_URL", "https://api.atlascloud.ai/v1"),
)
